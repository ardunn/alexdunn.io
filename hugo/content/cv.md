...
I'm a Ph.D. candidate in the [HackingMaterials group](https://hackingmaterials.lbl.gov) at [LBL](https://lbl.gov), and **I use computers to help find and design new materials;** particularly, I develop machine learning pipelines, run quantum-mechanical simulations, and develop open source software to help others do the same. I also work alongside the [Materials Project](https://materialsproject.org), an online reearch effort with over 100,000 registered users.
